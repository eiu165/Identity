...
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
namespace AspNet.Identity.NHibernate.Stores
{
    using System;
        ...
        where TUser : IdentityUser
    {
        ...
        public UserStore(
            ILinqRepository<IdentityUserClaim> claimRepository,
            ILinqRepository<IdentityUserLogin> loginRepository,
            ILinqRepositoryWithTypedId<IdentityRole, string> roleRepository,
            ILinqRepositoryWithTypedId<TUser, string> userRepository)
        {
